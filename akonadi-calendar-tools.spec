...
Source0  : https://download.kde.org/stable/release-service/20.12.3/src/akonadi-calendar-tools-20.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.3/src/akonadi-calendar-tools-20.12.3.tar.xz.sig
...
%prep
%setup -q -n akonadi-calendar-tools-20.12.3
cd %{_builddir}/akonadi-calendar-tools-20.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618642617
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-calendar-tools-20.12.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar-tools/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/akonadi-calendar-tools-20.12.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar-tools/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
