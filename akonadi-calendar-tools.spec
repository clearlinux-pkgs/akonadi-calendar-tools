...
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/akonadi-calendar-tools-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/akonadi-calendar-tools-22.04.1.tar.xz.sig
...
%prep
%setup -q -n akonadi-calendar-tools-22.04.1
cd %{_builddir}/akonadi-calendar-tools-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652709128
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-calendar-tools-22.04.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/akonadi-calendar-tools/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/akonadi-calendar-tools-22.04.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar-tools/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/akonadi-calendar-tools-22.04.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar-tools/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/akonadi-calendar-tools-22.04.1/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar-tools/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/akonadi-calendar-tools-22.04.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar-tools/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
